...
class CurvedNavigationBarCustomModel extends StatefulWidget {
  ...
  CurvedNavigationBarCustomModel({
    Key? key,
    required this.items,
    this.index = 0,
  ...
  @override
  CurvedNavigationBarCustomModelState createState() =>
      CurvedNavigationBarCustomModelState();
}

class CurvedNavigationBarCustomModelState
    extends State<CurvedNavigationBarCustomModel>
  ...
  @override
  void didUpdateWidget(CurvedNavigationBarCustomModel oldWidget) {
