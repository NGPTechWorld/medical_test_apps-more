...
class ColorManager {
  static const Color firstColor = Color(0xff008ede);
  static const Color firstDarkColor = Color(0xff224065);
  static const Color secoundColor = Color(0xff84c244);
  static const Color secoundDarkColor = Color(0xff618f32);
  //Color Light
